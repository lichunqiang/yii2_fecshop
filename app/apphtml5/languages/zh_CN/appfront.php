...
# 页面底部条款部分
 ...
 'From your My Account Dashboard you have the ability to view a snapshot of your recent account activity and update your account information. Select a link below to view or edit information.'
                                => '您可以在我的帐户信息中心查看最近帐户活动的快照，并更新您的帐户信息。 选择以下链接可查看或编辑信息。',
...
# 账户中心密码找回
 ...
 'We\'ve sent a message to the email address'
                                => '我们已经发送了一封邮件给这个邮箱地址',
 ...
 'click here' => '点击这里',
 'Email address do not exist, please {logUrlB} click here {logUrlE} to re-enter!'
                                => '邮件地址不存在，请{logUrlB}点击这里{logUrlE}重新进入',
 'Select your new password' => '请填写您的新密码',

 'reset you account success, you can {logUrlB} click here {logUrlE} to login .'
...
# 产品详细页面 - 产品描述部分
 'price' => '产品价格',
 'You already favorite this product'
                                => '您已经收藏该产品',
 'Average rating' => '平均评分',
 'reviews' => '评论',
 'Item Code:' => '产品编号：',
